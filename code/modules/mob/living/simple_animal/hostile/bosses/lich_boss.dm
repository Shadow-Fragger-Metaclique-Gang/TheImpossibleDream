/mob/living/simple_animal/hostile/boss/lich
	name = "Archlich"
	desc = "An incomprehensibly powerful necromancer, draped in the robes of the Demiurge's reign- a glimpse into what once was. The air around you crackles with unholy energy."
